const GAME_CONSTANTS = {
    ...
    API_ENDPOINTS: {
        ...
        NEXT_MOVE: 'http://127.0.0.1:5000/api/nextmove/',
        LIST_GAMES: (inProgressOnly = true) => `http://127.0.0.1:5000/api/games?in_progress=${inProgressOnly}`,
        LIST_BOT_GAMES: (inProgressOnly = false) => `http://127.0.0.1:5000/api/bot-games?in_progress=${inProgressOnly}`,
